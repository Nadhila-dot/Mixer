...
4. Go to https://console.vultr.com/startup/ and create a new startup script with the following content (replace the env vars with your own values) and save it
```bash
#!/usr/bin/env bash
set -euo pipefail
